...
<body>
    <nav class="relative select-none bg-gray-200 lg:flex lg:items-stretch w-full">
        ...
        <div class="lg:flex lg:items-stretch lg:flex-no-shrink lg:flex-grow">
                ...
                <div >
                    <div class="flex w-full h-[50%] mx-10 my-3 rounded bg-white">
                        <input class=" w-full border-none bg-transparent px-4  text-gray-400 outline-none focus:outline-none " type="search" name="search" placeholder="Search..." />
                        <button type="submit" class="m-2 rounded  px-4  text-amber-400">
