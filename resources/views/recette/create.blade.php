    ...
    <section class="max-w-4xl p-6 mx-auto  bg-gray-200 rounded-md shadow-xl mt-[5%]">
        ...
        <form action="{{route('recette.store')}}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <textarea id="ingredients" name="ingredients" value="{{old('ingredients')}}"
                    class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring"></textarea>
                    @error('ingredients')
                    <div class="text-red-500">
                        {{$message}}
            ...
            <div>
                ...
                <textarea id="prepare" name="prepare" value="{{old('prepare')}}"
                    class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring"></textarea>
                    @error('prepare')
                    <div class="text-red-500">
                        {{$message}}
            ...
            <div class="col-span-2 flex justify-end">
                <button type="submit"
                    class="px-8 py-2 leading-5 text-white transition-colors duration-200 transform bg-gray-500 rounded-md hover:bg-gray-800 focus:outline-none focus:bg-gray-600">Save</button>
            </div>
