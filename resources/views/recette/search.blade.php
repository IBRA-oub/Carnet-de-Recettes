...
<body>
    <nav class="relative select-none bg-gray-200 lg:flex lg:items-stretch w-full">
        ...
        <div class="lg:flex lg:items-stretch lg:flex-no-shrink lg:flex-grow">
            ...
            <div class="flex h-8 w-full mx-10 my-3">
                <form action="{{ route('recette.search') }}" method="GET" class="flex items-center bg-white rounded">
                    <input class="flex-grow border-none bg-transparent px-4 py-2 text-gray-400 outline-none focus:outline-none" type="search" name="search" placeholder="Search..." />
